...
Bring up the corridor world + robot + ROS<->Gazebo bridge.
    ...
    ros2 launch shifting_wall_slam bringup.launch.py
    ros2 launch shifting_wall_slam bringup.launch.py render_engine:=ogre  # no-GPU
    ros2 launch shifting_wall_slam bringup.launch.py rviz:=true
