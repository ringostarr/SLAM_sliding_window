...
and the Section 3 noise node.
    ...
    ros2 launch shifting_wall_slam pipeline.launch.py render_engine:=ogre
...
def generate_launch_description():
    ...
    panel_mover = Node(
        package="shifting_wall_slam", executable="panel_mover",
    ...
    noise_node = Node(
        package="shifting_wall_slam", executable="noise_node",
